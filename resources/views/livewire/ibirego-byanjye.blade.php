<div class="container mx-auto p-1">
    ...
    @else
        ...
        <ul class="flex flex-wrap -mb-px font-medium text-center">
            <li class="mr-2">
            <button class="inline-block p-1 border-b-2 rounded-t-lg"
            ...
            <table class="table-auto min-w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.id') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.ttitle') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.offender') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.phone') }}</th> 
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.witness') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.status') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.location') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.date') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.updated') }}</th>
                        <th class="border border-gray-300 px-2 py-1">{{ __('ibirego.action') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($disputes->where('status', $activeTab) as $dispute)
                        <tr class="hover:bg-gray-50 {{ $dispute->status === 'kirabitse' ? 'cursor-pointer' : '' }}" 
                            ...
                            @endif
                        >
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->id }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->title }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->offender_name }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->offender_mail }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->witness_name }}</td>
                            ...
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->location_name }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->created_at->format('Y-m-d H:i') }}</td>
                            <td class="border border-gray-300 px-2 py-1">{{ $dispute->updated_at->format('Y-m-d H:i') }}</td>
                            <td class="border border-gray-300 px-2 py-1">
                                @if($dispute->status === 'cyakemutse')
